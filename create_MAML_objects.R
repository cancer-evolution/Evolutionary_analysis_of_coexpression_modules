...
annotations_pheo_MAML <- annotations_pheo[annotations_pheo$Genotype_Cluster %in% c("MAML"),]
table(annotations_pheo_MAML$Malignancy)


normal <- as.character(annotations_pheo$Sample[annotations_pheo$Malignancy == "Normal"])
benign <- as.character(annotations_pheo_MAML$Sample[annotations_pheo_MAML$Malignancy == "Benign"])
malignant <- as.character(annotations_pheo_MAML$Sample[annotations_pheo_MAML$Malignancy == "Malignant"])
...
#save(sft, file="sft_paired_pheo_MAML.Rdata")
load("sft_paired_pheo_MAML.Rdata")
...
for(type in c("normal", "benign", "malignant")){
    ...
    for(cluster in cluster_names){
      ...
      save(sub_networks, file=paste("Subnetworks_pheo_", type, "_MAML.Rdata", sep=""))
      
    }
    print(type)
}

save(modules_pheo, file="modules_pheo_MAML.Rdata")
load("modules_pheo_MAML.Rdata")

##Calculate age and novelty, and centrality of genes
###Compare the tumour vs. normal modules, and see which modules are more conserved, and which are
#more variable
#Functional enrichment of modules, and building of a network of modules
...
save(age_enrichment, file="age_enrichment_pheo_MAML.Rdata")
#load("age_enrichment_pheo_MAML.Rdata")
...
#save(number_of_shared_genes, file="number_of_shared_genes_pheo_MAML.Rdata")

##Novelty
source("functions.R")
load("number_of_shared_genes_pheo_MAML.Rdata")
...
#save(preservation_pheo, file="preservation_pheo_MAML.Rdata")
load("preservation_pheo_MAML.Rdata")
...
save(all_preservation_pheo, file="all_preservation_pheo_MAML.Rdata")
